...
public class BasicTableCreateDlg extends JDialog implements ActionListener {
    ...
    public BasicTableCreateDlg(XXDBJTable table) {
        ...
        cmdAdd.setText("+");
        cmdAdd.setBounds(241, 10, adjWidth, adjHeight);
        cmdAdd.addActionListener(this);
        panel.add(cmdAdd,BorderLayout.EAST);

        final JButton cmdMinus = new JButton();
        cmdMinus.setText("-");
        cmdMinus.setBounds(241, 10, adjWidth, adjHeight);
        cmdMinus.addActionListener(this);
        panel.add(cmdMinus,BorderLayout.EAST);
